...
/* Uncomment the line below according to the target STM32 device used in your
  ...
  */
  ...
  /* #define STM32F40XX */   /*!< STM32F40xx : STM32F4xx family with 1M Flash memory */
  /* #define STM32F427X */   /*!< STM32F427x : STM32F4xx family with 2M Flash memory */
  #define STM32F429X    /*!< STM32F429x: STM32F4xx family with 2M Flash memory and new standard peripherals */
#endif
...
/**
 * @brief STM32F4XX Standard Peripherals Library version number V1.1.0CR1
   */
...
/******  STM32 specific Interrupt Numbers **********************************************************************/
  ...
  LCD_IRQn                    = 88,     /*!< LCD global Interrupt                                              */
  LCD_ER_IRQn                 = 89,     /*!< LCD Error global Interrupt                                        */
...
typedef struct
{
  ...
  __IO uint32_t CSGM0R; /*!< CRYP GCM/GMAC context swap register 0,            Address offset: 0x50 */
  __IO uint32_t CSGM1R; /*!< CRYP GCM/GMAC context swap register 1,            Address offset: 0x54 */
  __IO uint32_t CSGM2R; /*!< CRYP GCM/GMAC context swap register 2,            Address offset: 0x58 */
  __IO uint32_t CSGM3R; /*!< CRYP GCM/GMAC context swap register 3,            Address offset: 0x5C */
  __IO uint32_t CSCM0R; /*!< CRYP CCM/CMAC context swap register 0,            Address offset: 0x60 */
  __IO uint32_t CSCM1R; /*!< CRYP CCM/CMAC context swap register 1,            Address offset: 0x64 */
  __IO uint32_t CSCM2R; /*!< CRYP CCM/CMAC context swap register 2,            Address offset: 0x68 */
  __IO uint32_t CSCM3R; /*!< CRYP CCM/CMAC context swap register 3,            Address offset: 0x6C */
} CRYP_TypeDef;
...
#ifdef STM32F429X
#define  PWR_CR_FBBEN                        ((uint32_t)0x00010000)     /*!< FBB enabled                                                */
#define  PWR_CR_FBBSWEN                      ((uint32_t)0x00020000)     /*!< FBB switch enabled                                         */
#define  PWR_CR_RBBNEN                       ((uint32_t)0x00040000)     /*!< RBB N-Mos generator enabled in stop mode                   */
#define  PWR_CR_RBBPEN                       ((uint32_t)0x00080000)     /*!< RBB P-Mos generator enabled in stop mode                   */
#endif /* STM32F429X */
...
#ifdef STM32F429X
#define  PWR_CSR_FBBRDY                      ((uint32_t)0x00010000)     /*!< FBB generator ready                              */
#define  PWR_CSR_FBBSWRDY                    ((uint32_t)0x00020000)     /*!< FBB Switch ready                                 */  
#endif /* STM32F429X */
/* Legacy define */
...
#ifdef STM32F429X
#define  RCC_APB2RSTR_LCDRST                 ((uint32_t)0x04000000)
#endif /* STM32F429X */
...
#ifdef STM32F429X
#define  RCC_APB2ENR_LCDEN                   ((uint32_t)0x04000000)
#endif /* STM32F429X */
...
#ifdef STM32F429X
#define  RCC_APB2LPENR_LCDLPEN               ((uint32_t)0x04000000)
#endif /* STM32F429X */
...
#define  SAI_xCR2_MUTECNT                 ((uint32_t)0x00000FC0)        /*!<MUTECNT[5:0] (MUTE counter) */
#define  SAI_xCR2_MUTECNT_0               ((uint32_t)0x00000FC0)        /*!<Bit 0 */
#define  SAI_xCR2_MUTECNT_1               ((uint32_t)0x00000FC0)        /*!<Bit 1 */
#define  SAI_xCR2_MUTECNT_2               ((uint32_t)0x00000040)        /*!<Bit 2 */
#define  SAI_xCR2_MUTECNT_3               ((uint32_t)0x00000080)        /*!<Bit 3 */
#define  SAI_xCR2_MUTECNT_4               ((uint32_t)0x00000100)        /*!<Bit 4 */
#define  SAI_xCR2_MUTECNT_5               ((uint32_t)0x00000200)        /*!<Bit 5 */

#define  SAI_xCR2_COMP                    ((uint32_t)0x000000E0)        /*!<COMP[1:0] (Companding mode) */
#define  SAI_xCR2_COMP_0                  ((uint32_t)0x00000020)        /*!<Bit 0 */
#define  SAI_xCR2_COMP_1                  ((uint32_t)0x00000040)        /*!<Bit 1 */
